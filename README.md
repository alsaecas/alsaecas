...
* **Smart contracts and protocol logic** — permissions, state machines, incentives, deadlines, escrow, and payment rules
* **Programmable payments** — agent spending policies, payment intents, wallets, receipts, and authorization boundaries
...
| **Blockchain ecosystems** | Ethereum/EVM, Camino Network, Casper, Tether WDK, wallets, IPFS                   |
| **Infrastructure**        | Docker, GitHub Actions, GitLab CI/CD, Gradle, Vercel, AWS services                |
| **Frontend and product**  | React, Next.js, Gatsby, wallet flows, dashboards, marketplaces, KYC integrations  |
...
ERC20-funded bounty marketplace with escrow, submissions, deadlines, winner selection, cancellation rules, and payout execution.
...
* Treat authentication, wallets, signatures, providers, and external data as reliability boundaries.
...
I am open to remote opportunities involving **senior backend engineering, smart contracts, blockchain platforms, Web3 infrastructure, programmable payments, and technically ambitious product development**.
